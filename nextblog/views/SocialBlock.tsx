import { Card, SSRProvider, Tab, Tabs } from 'react-bootstrap';
                ...
                <Tabs variant="pills" defaultActiveKey="weibo" className="mb-3">
                    ...
                    <Tab tabClassName="rounded-pill" id="twitter-social-tab" eventKey="twitter" title={<span><FaTwitter className="mx-1 d-inline" />{"Twitter"}</span>}>
                        ...
                        <div className='tw-rounded-3xl'>
                            <a className="twitter-timeline" data-height="450" data-theme="dark" href="https://twitter.com/prinOrange_?ref_src=twsrc%5Etfw">Tweets by prinOrange_</a>
                        </div>
                    </Tab>
                </Tabs>
            </Card.Body>
